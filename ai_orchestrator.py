...
def create_get_demographic_data_tool():
    ...
    get_demographic_data_declaration = FunctionDeclaration(
        ...
        description=get_demographic_data.__doc__,
        parameters={
            "type": "object",
            "properties": {
                "geography_level": {
                ...
                "state_name": {"type": "string", "description": "The name of the state."},
...
async def get_ai_response(user_query: str, chat_history: list = None) -> str:
    """
    ...
    try:
        ...
        if not response.candidates or not response.candidates[0].content.parts:
            return "AI did not return a valid response structure."
        ...
        if hasattr(response_part, 'function_call') and response_part.function_call:
            ...
            if function_name in AVAILABLE_FUNCTIONS:
                ...
                try:
                    ...
                    print(f"Tool '{function_name}' executed. Result: {tool_execution_result}")
                ...
                if not response_after_tool.candidates or not response_after_tool.candidates[0].content.parts:
                    return "AI did not return a valid response structure after tool execution."
                ...
                if hasattr(final_response_part, 'text'):
                    ...
                    return "AI processed tool output, but no text response was generated."
            else:
                return f"Error: Model tried to call unknown function '{function_name}'."
        
        elif hasattr(response_part, 'text'):
            return response_part.text
        
        return "Sorry, I couldn't generate a valid response (no function call or text)."

    except Exception as e:
        print(f"Error in get_ai_response: {e}")
        import traceback
        traceback.print_exc()
        return "Sorry, there was a critical error in the AI orchestration."
